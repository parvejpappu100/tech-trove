    ...
    return (
        <div>
            ...
            <div className='lg:container mx-auto px-4 my-24 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5'>
                {
                    saved.length !== 0 ? saved.map(item => <SavedProduct key={item._id} refetchSaved={refetchSaved} item={item}></SavedProduct>) : <div className='bg-[#15407F] py-3 text-white ps-5 font-semibold'>
